...
2. **A new public key párhuzamos verifikálása** — két public key töltése a `JwtConfigFactory`-be. *(M5-ben épül, jelenleg single-key.)*
...
!!! info "Jelenleg single-key"
    Az M2.a egy aktív kulcsot támogat. A multi-key rotation az M5 hatóköre.
